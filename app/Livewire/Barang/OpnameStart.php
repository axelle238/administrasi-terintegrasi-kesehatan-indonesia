...
class OpnameStart extends Component
{
    public $tanggal;
    public $ruangan_id;
    ...
    public function store()
    {
        ...
        DB::transaction(function () {
            ...
            // Redirect directly to input page
            $this->redirect(route('barang.opname.input', $opname->id), navigate: true);
        });
    }

    public function render()
    {
        return view('livewire.barang.opname-start', [
            'ruangans' => Ruangan::orderBy('nama_ruangan')->get()
        ])->layout('layouts.app', ['header' => 'Mulai Sesi Opname']);
    }
}
