                    ...
                    <form method="POST" action="{{ route('obat.update', $obat->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="kode_obat" class="block mt-1 w-full" type="text" name="kode_obat" :value="old('kode_obat', $obat->kode_obat)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select id="jenis_obat" name="jenis_obat" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                    ...
                                    <option value="Alat Kesehatan" {{ $obat->jenis_obat == 'Alat Kesehatan' ? 'selected' : '' }}>Alat Kesehatan</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="min_stok" class="block mt-1 w-full" type="number" name="min_stok" :value="old('min_stok', $obat->min_stok)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="batch_number" class="block mt-1 w-full" type="text" name="batch_number" :value="old('batch_number', $obat->batch_number)" placeholder="Opsional" />
                                <x-input-error :messages="$errors->get('batch_number')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="no_izin_edar" :value="__('No. Izin Edar (BPOM)')" />
                                <x-text-input id="no_izin_edar" class="block mt-1 w-full" type="text" name="no_izin_edar" :value="old('no_izin_edar', $obat->no_izin_edar)" placeholder="Opsional" />
                                <x-input-error :messages="$errors->get('no_izin_edar')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="pabrik" :value="__('Pabrik / Principal')" />
                                <x-text-input id="pabrik" class="block mt-1 w-full" type="text" name="pabrik" :value="old('pabrik', $obat->pabrik)" placeholder="Opsional" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="harga_satuan" class="block mt-1 w-full" type="number" name="harga_satuan" :value="old('harga_satuan', $obat->harga_satuan)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_kedaluwarsa" class="block mt-1 w-full" type="date" name="tanggal_kedaluwarsa" :value="old('tanggal_kedaluwarsa', $obat->tanggal_kedaluwarsa)" required />
