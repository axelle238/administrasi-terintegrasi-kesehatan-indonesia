...
<!-- H. MANAJEMEN HALAMAN DEPAN (CMS) -->
@if(Auth::user()->role === 'admin')
<x-nav.dropdown label="Manajemen Halaman Depan" :active="request()->routeIs('system.cms.*')">
    <x-slot:icon>
    ...
    <x-nav.link-child :href="route('system.cms.index')" :active="request()->routeIs('system.cms.*')">Editor Tampilan Publik</x-nav.link-child>
</x-nav.dropdown>
@endif
