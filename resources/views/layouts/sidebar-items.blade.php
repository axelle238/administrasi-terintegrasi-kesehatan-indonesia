...
<x-nav.dropdown label="Kesehatan Masyarakat" :active="request()->routeIs('ukm.*') || request()->routeIs('masyarakat.*') || request()->routeIs('public.*')">
    ...
    <x-nav.link-child :href="route('ukm.index')" :active="request()->routeIs('ukm.index')">Dashboard UKM</x-nav.link-child>
...
<x-nav.dropdown label="Sistem Pengaturan" :active="request()->routeIs('system.*') && !request()->routeIs('system.backup')">
    <x-slot:icon>
...
<!-- G. KEAMANAN TERPUSAT -->
@if(Auth::user()->role === 'admin')
<x-nav.dropdown label="Keamanan" :active="request()->routeIs('security.*') || request()->routeIs('activity-log') || request()->routeIs('system.backup')">
    <x-slot:icon>
