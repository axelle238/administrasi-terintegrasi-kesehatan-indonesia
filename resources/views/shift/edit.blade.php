                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('shift.update', $shift->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama_shift" class="block mt-1 w-full" type="text" name="nama_shift" :value="old('nama_shift', $shift->nama_shift)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="jam_mulai" class="block mt-1 w-full" type="time" name="jam_mulai" :value="old('jam_mulai', $shift->jam_mulai)" required />
                                <x-input-error :messages="$errors->get('jam_mulai')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="jam_selesai" :value="__('Jam Selesai')" />
                                <x-text-input id="jam_selesai" class="block mt-1 w-full" type="time" name="jam_selesai" :value="old('jam_selesai', $shift->jam_selesai)" required />
