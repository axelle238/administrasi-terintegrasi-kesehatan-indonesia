                    ...
                    <form method="POST" action="{{ route('barang.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select id="kategori_barang_id" name="kategori_barang_id" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>
                                    ...
                                    @foreach($kategoris as $kategori)
                                        <option value="{{ $kategori->id }}" {{ old('kategori_barang_id') == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama_kategori }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="kode_barang" class="block mt-1 w-full" type="text" name="kode_barang" :value="old('kode_barang')" required placeholder="Contoh: INV-2024-001" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="lokasi_penyimpanan" class="block mt-1 w-full" type="text" name="lokasi_penyimpanan" :value="old('lokasi_penyimpanan')" placeholder="Contoh: Gudang B, Lemari 1" />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_pengadaan" class="block mt-1 w-full" type="date" name="tanggal_pengadaan" :value="old('tanggal_pengadaan')" required />
