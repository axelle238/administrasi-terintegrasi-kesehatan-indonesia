                    ...
                    <form method="POST" action="{{ route('pegawai.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="jabatan" class="block mt-1 w-full" type="text" name="jabatan" :value="old('jabatan')" required placeholder="Contoh: Dokter Umum / Staff IT" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="no_str" class="block mt-1 w-full" type="text" name="no_str" :value="old('no_str')" placeholder="Surat Tanda Registrasi" />
                                <x-input-error :messages="$errors->get('no_str')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="masa_berlaku_str" :value="__('Masa Berlaku STR')" />
                                <x-text-input id="masa_berlaku_str" class="block mt-1 w-full" type="date" name="masa_berlaku_str" :value="old('masa_berlaku_str')" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="no_sip" class="block mt-1 w-full" type="text" name="no_sip" :value="old('no_sip')" placeholder="Surat Izin Praktik" />
                                <x-input-error :messages="$errors->get('no_sip')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="masa_berlaku_sip" :value="__('Masa Berlaku SIP')" />
                                <x-text-input id="masa_berlaku_sip" class="block mt-1 w-full" type="date" name="masa_berlaku_sip" :value="old('masa_berlaku_sip')" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="alamat" name="alamat" rows="2" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>{{ old('alamat') }}</textarea>
