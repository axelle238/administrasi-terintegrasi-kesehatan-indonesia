        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="block text-2xl font-extrabold text-slate-900 tracking-tight leading-none">{{ $pengaturan['nama_aplikasi'] }}</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">{{ $fitur['title'] }}</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="flex items-center gap-3 mb-4 md:mb-0">
                    ...
                    <div>
                        <span class="font-bold text-slate-900 block leading-tight">{{ $pengaturan['nama_aplikasi'] }}</span>
                        <span class="text-xs text-slate-500">{{ $pengaturan['alamat'] }} | {{ $pengaturan['telepon'] }}</span>
                    </div>
                </div>
                <div class="text-slate-500 text-sm">
                    &copy; {{ date('Y') }} {{ $pengaturan['nama_aplikasi'] }}. Hak Cipta Dilindungi.
                </div>
            </div>
        </div>
    </footer>
