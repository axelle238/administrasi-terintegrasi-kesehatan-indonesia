        ...
        <div class="relative pt-10 px-8 pb-8 text-center">
            ...
            @if(!$todayPresensi)
                ...
                <div class="grid grid-cols-3 gap-3 mb-8">
                    <button wire:click="setKategori('WFO')" class="p-3 rounded-2xl border-2 {{ $kategori === 'WFO' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-slate-100 bg-white text-slate-500 hover:border-blue-200' }} transition-all flex flex-col items-center gap-2">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                        <span class="text-[10px] font-bold uppercase">Kantor (WFO)</span>
                    </button>
                    <button wire:click="setKategori('Dinas Luar')" class="p-3 rounded-2xl border-2 {{ $kategori === 'Dinas Luar' ? 'border-emerald-500 bg-emerald-50 text-emerald-700' : 'border-slate-100 bg-white text-slate-500 hover:border-emerald-200' }} transition-all flex flex-col items-center gap-2">
                    ...
                    <button wire:click="setKategori('WFH')" class="p-3 rounded-2xl border-2 {{ $kategori === 'WFH' ? 'border-purple-500 bg-purple-50 text-purple-700' : 'border-slate-100 bg-white text-slate-500 hover:border-purple-200' }} transition-all flex flex-col items-center gap-2">
                ...
                <div class="mb-6 p-4 rounded-xl bg-slate-50 border border-slate-100 text-left">
                    ...
                    <p class="text-xs text-slate-700 italic">
                        ...
                        @elseif($kategori === 'Dinas Luar')
                            "Melakukan perjalanan dinas/kunjungan lapangan sesuai surat tugas."
                        @else
