<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white tracking-tight">Edit Data Ruangan</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Pembaruan informasi untuk {{ $ruangan->nama_ruangan }}</p>
        </div>
