                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input wire:model="nama_obat" id="nama_obat" class="block mt-1 w-full" type="text" placeholder="Contoh: Paracetamol 500mg" required />
                            <x-input-error :messages="$errors->get('nama_obat')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="jenis_obat" value="Bentuk Sediaan" />
                        ...
                        <div>
                            <x-input-label for="golongan" value="Golongan Obat" />
                            <select wire:model="golongan" id="golongan" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                         ...
                         <div>
                            ...
                            <x-text-input wire:model="satuan" id="satuan" class="block mt-1 w-full" type="text" placeholder="Pcs, Strip, Botol" required />
