<div class="space-y-6">
    @if($isOpen)
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden animate-fade-in">
            <div class="p-8 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                ...
                <button wire:click="$set('isOpen', false)" class="p-2 hover:bg-white rounded-full text-slate-400">
    ...
    @else
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
            ...
            <button wire:click="create" class="px-6 py-3 bg-amber-500 text-white rounded-xl font-bold hover:bg-amber-600 transition-all shadow-lg shadow-amber-500/30 flex items-center gap-2 relative overflow-hidden">
