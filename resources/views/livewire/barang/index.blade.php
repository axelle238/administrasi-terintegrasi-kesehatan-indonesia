<div class="space-y-6 animate-fade-in">
    ...
    <div class="bg-white p-2 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col lg:flex-row gap-2">
        ...
        <div class="relative w-full lg:w-80">
            <input type="text" wire:model.live.debounce.300ms="cari" placeholder="Cari aset, kode, atau merk..." class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-700 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 transition-all">
                    ...
                    <tr>
                        <td colspan="6" class="px-8 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-slate-500 font-bold text-sm">Data barang tidak ditemukan.</p>
