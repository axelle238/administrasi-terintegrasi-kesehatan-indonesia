<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wide">Total Item</p>
        ...
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wide">Nilai Aset</p>
                <p class="text-xl font-bold text-gray-900">Rp {{ number_format($nilaiAset, 0, ',', '.') }}</p>
            </div>
        </div>
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wide">Kondisi Rusak</p>
                <p class="text-xl font-bold text-gray-900">{{ number_format($asetRusak) }}</p>
            </div>
        </div>
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 cursor-pointer hover:bg-orange-50 transition" wire:click="$set('filterLowStock', true)">
                        ...
                        <tr class="hover:bg-gray-50/80 transition duration-150 ease-in-out group {{ in_array($barang->id, $selected) ? 'bg-teal-50/30' : '' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap hidden md:table-cell">
                                ...
                                <div class="text-xs text-gray-500 flex items-center gap-1 mt-1">
                                    ...
                                    {{ $barang->ruangan ? $barang->ruangan->nama_ruangan : ($barang->lokasi_penyimpanan ?: 'Belum diset') }}
                                </div>
                            </td>
