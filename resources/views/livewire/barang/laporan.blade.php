<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 no-print">
        ...
        <div class="mt-4 flex justify-end gap-3">
            <button wire:click="exportCsv" wire:loading.attr="disabled" class="bg-teal-600 text-white px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 hover:bg-teal-700 transition">
                <svg wire:loading.remove xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
