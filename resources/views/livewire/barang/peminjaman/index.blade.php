<div class="space-y-6">
    @if($isModalOpen)
        <!-- Create Form -->
        <div class="bg-white p-8 rounded-[2.5rem] shadow-lg border border-blue-100 mb-8 animate-fade-in">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-bold text-slate-800">Form Peminjaman Baru</h3>
                <button wire:click="create" class="p-2 hover:bg-slate-100 rounded-full text-slate-400">
            ...
            <form wire:submit.prevent="store" class="space-y-6">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-slate-100">
                    <button type="button" wire:click="create" class="px-6 py-3 bg-slate-100 text-slate-600 rounded-xl font-bold">Batal</button>
                    <button type="submit" class="px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700">Simpan</button>
                </div>
            </form>
        </div>

    @elseif($isReturnModalOpen)
        <!-- Return Form -->
        <div class="bg-amber-50 p-8 rounded-[2.5rem] shadow-lg border border-amber-100 mb-8 animate-fade-in">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-bold text-amber-800">Form Pengembalian Barang</h3>
                <button wire:click="$set('isReturnModalOpen', false)" class="p-2 hover:bg-amber-100 rounded-full text-amber-700">
                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
                </button>
            </div>
            ...
            <form wire:submit.prevent="processReturn" class="space-y-6">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-amber-200">
    ...
    @else
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
            ...
            <button wire:click="create" class="px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/30 flex items-center gap-2 relative overflow-hidden">
