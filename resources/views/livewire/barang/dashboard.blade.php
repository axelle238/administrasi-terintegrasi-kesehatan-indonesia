        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('barang.index', ['filterLowStock' => true]) }}" class="text-xs text-red-600 font-bold hover:underline">Lihat Semua</a>
                </div>
            ...
            <div class="bg-teal-700 rounded-2xl shadow-lg p-6 text-white">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <a href="{{ route('barang.penyusutan') }}" class="bg-white/10 hover:bg-white/20 p-3 rounded-xl text-center backdrop-blur-sm transition-colors col-span-2 md:col-span-1">
                        <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
                        <span class="text-xs font-semibold">Penyusutan Aset</span>
                    </a>
                </div>
            </div>
        </div>
