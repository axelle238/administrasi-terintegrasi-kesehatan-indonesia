<div class="space-y-6">
    @if($isModalOpen)
        <!-- Form Section -->
        <div class="bg-white p-8 rounded-[2.5rem] shadow-lg border border-blue-100 relative overflow-hidden animate-fade-in">
            ...
            <div class="flex justify-between items-start mb-6 relative z-10">
                <div>
                    <h3 class="text-2xl font-black text-slate-800">Formulir Perpindahan Aset</h3>
                    <p class="text-sm text-slate-500">Catat pemindahan lokasi barang.</p>
                </div>
                <button wire:click="create" class="p-2 bg-slate-100 rounded-full text-slate-500 hover:bg-slate-200 transition-colors">
            ...
            <form wire:submit.prevent="store" class="relative z-10 space-y-6">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-slate-100">
                    <button type="button" wire:click="create" class="px-6 py-3 bg-slate-100 text-slate-600 rounded-xl font-bold hover:bg-slate-200 transition-colors">Batal</button>
