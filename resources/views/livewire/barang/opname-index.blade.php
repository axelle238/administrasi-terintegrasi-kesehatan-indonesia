<div class="space-y-6">
    @if($isOpen)
        <!-- Form Section -->
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8" wire:key="view-form">
            <div class="flex justify-between items-start mb-8">
                ...
                <button type="button" wire:click="closeForm" class="p-2 bg-slate-100 rounded-full text-slate-500 hover:bg-slate-200 transition-colors">
            ...
            <form wire:submit.prevent="store" class="space-y-6 max-w-3xl">
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-slate-100">
                    <button type="button" wire:click="closeForm" class="px-6 py-3 bg-slate-100 text-slate-600 rounded-xl font-bold hover:bg-slate-200 transition-colors">Batal</button>
    ...
    @else
        ...
        <div class="space-y-6" wire:key="view-list">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
                ...
                <button type="button" wire:click="openForm" wire:loading.attr="disabled" class="px-6 py-3 bg-purple-600 text-white rounded-xl font-bold hover:bg-purple-700 transition-all shadow-lg shadow-purple-500/30 flex items-center gap-2 relative overflow-hidden">
                    <span wire:loading.remove wire:target="openForm" class="flex items-center gap-2">
                    ...
                    <span wire:loading wire:target="openForm" class="flex items-center gap-2">
