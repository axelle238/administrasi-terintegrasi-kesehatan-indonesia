<div class="space-y-6">
    @if($isOpen)
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 animate-fade-in">
            <div class="flex justify-between items-start mb-8">
                ...
                <button wire:click="$set('isOpen', false)" class="p-2 bg-slate-100 rounded-full text-slate-500 hover:bg-slate-200 transition-colors">
    ...
    @else
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
            ...
            <button wire:click="create" class="px-6 py-3 bg-purple-600 text-white rounded-xl font-bold hover:bg-purple-700 transition-all shadow-lg shadow-purple-500/30 flex items-center gap-2 relative overflow-hidden">
