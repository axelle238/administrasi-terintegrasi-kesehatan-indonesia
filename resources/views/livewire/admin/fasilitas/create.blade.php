        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1">
                    ...
                    <input wire:model="nama_fasilitas" type="text" id="nama_fasilitas" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition-all font-bold text-slate-800" placeholder="Contoh: Ruang Rawat Inap VVIP">
            ...
            <div class="space-y-1">
                ...
                <textarea wire:model="deskripsi" id="deskripsi" rows="4" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition-all text-sm leading-relaxed" placeholder="Jelaskan fasilitas ini..."></textarea>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-300 border-dashed rounded-xl cursor-pointer bg-slate-50 hover:bg-slate-100 transition-colors">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="text-sm text-slate-500"><span class="font-bold text-blue-600">Klik untuk upload</span></p>
