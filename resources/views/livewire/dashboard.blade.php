<div class="space-y-8">
        ...
        <div class="relative z-10 px-8 py-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                ...
                <h2 class="text-4xl font-extrabold text-slate-800 tracking-tight mb-2 font-[Outfit]">
                    Welcome back, <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">{{ Auth::user()->name }}</span>
                </h2>
                <p class="text-slate-500 text-lg max-w-2xl font-medium">
                    Here's your enterprise overview for today. All systems are running smoothly.
                </p>
                
                <div class="mt-8 flex flex-wrap gap-4">
                    <button class="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white shadow-md shadow-slate-200/50 hover:shadow-lg hover:shadow-blue-500/10 transition-all border border-slate-100 group">
                    ...
                    <button class="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white shadow-md shadow-slate-200/50 hover:shadow-lg hover:shadow-cyan-500/10 transition-all border border-slate-100 group">
                        ...
                        <span class="text-sm font-bold text-slate-700">Create Report</span>
                    </button>
                </div>
            </div>
                ...
                <div class="relative bg-white/60 backdrop-blur-xl border border-white/50 rounded-3xl p-6 min-w-[260px] shadow-lg shadow-blue-500/5">
                    <div class="flex justify-between items-start mb-6">
                        <div class="flex flex-col">
                            <span class="text-xs text-slate-500 uppercase font-bold tracking-wider">Local Time</span>
                            <span class="text-xs text-blue-600 font-bold">Jakarta, ID</span>
                        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center gap-2">
                    <span class="text-xs font-bold text-cyan-600 bg-cyan-50 px-2 py-0.5 rounded-full">Live</span>
                    <span class="text-xs text-slate-400 font-medium">pasien menunggu</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-slate-400 font-medium mt-2">{{ $kamarTersedia }} bed tersedia</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="text-xs font-bold text-slate-400 uppercase tracking-widest">Stok Menipis</span>
                </div>
                <h3 class="text-3xl font-extrabold text-slate-800 mb-1">{{ $obatMenipis }}</h3>
                <div class="flex items-center gap-2">
                    <span class="text-xs font-bold text-rose-600 bg-rose-50 px-2 py-0.5 rounded-full">Warning</span>
                    <span class="text-xs text-slate-400 font-medium">item perlu restock</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex flex-col justify-between">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-slate-400 font-medium mt-1">Trend pasien 6 bulan terakhir</p>
                </div>
                <div class="flex gap-2">
                    <button class="px-4 py-2 text-xs font-bold rounded-xl bg-blue-50 text-blue-600 border border-blue-100">Grafik</button>
                    <button class="px-4 py-2 text-xs font-bold rounded-xl bg-white text-slate-400 hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-all">Tabel</button>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-8 shadow-[0_10px_40px_-10px_rgba(16,185,129,0.3)] text-white flex flex-col relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col h-full justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 text-sm">Overview finansial 7 hari terakhir</p>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center border-b border-white/20 pb-4 mb-4">
                        ...
                        <span class="text-2xl font-bold">Rp {{ number_format(array_sum($revenueData['data'])) }}</span>
                    </div>
    ...
    <div class="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-xl font-bold text-slate-800">Early Warning System (EWS)</h3>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="flex p-4 rounded-2xl bg-blue-50 border border-blue-100 hover:shadow-md hover:shadow-blue-500/5 transition-all cursor-pointer group">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1 leading-relaxed"><strong class="text-blue-600">{{ $suratMasuk }} surat baru</strong> belum didisposisikan. Cek inbox administrasi.</p>
                </div>
            </div>
        </div>
    </div>
