<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white tracking-tight">Tambah Supplier Baru</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Silakan isi formulir di bawah ini untuk menambahkan supplier baru ke sistem.</p>
        </div>
