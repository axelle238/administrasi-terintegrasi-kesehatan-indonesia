        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <form wire:submit="save">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 mt-2">
                            <label class="inline-flex items-center">
                                <input type="radio" wire:model.live="jenis_surat" value="Masuk" class="form-radio text-indigo-600">
                                <span class="ml-2">Surat Masuk</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" wire:model.live="jenis_surat" value="Keluar" class="form-radio text-indigo-600">
                    ...
                    @if($jenis_surat == 'Masuk')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input wire:model="pengirim" id="pengirim" class="block mt-1 w-full" type="text" placeholder="Instansi / Perorangan" required />
                            </div>
                            <div>
                    ...
                    <div>
                        <x-input-label for="file_surat" value="File Lampiran (PDF/Image)" />
                        ...
                        <div wire:loading wire:target="file_surat" class="text-sm text-blue-500 mt-1">Uploading...</div>
                    ...
                    @if($jenis_surat == 'Masuk')
                        <div class="bg-yellow-50 p-4 rounded-md border border-yellow-200 mt-4">
                            <h4 class="font-bold text-gray-700 mb-2">Disposisi (Opsional)</h4>
